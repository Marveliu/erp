...
namespace Demo.BLL
{
	...
	{
		private readonly Demo.DAL.tb_JH_MRP dal=new Demo.DAL.tb_JH_MRP();
		public tb_JH_MRP()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Demo.Model.tb_JH_MRP GetModelByCache(string ID)
		{
			
			string CacheKey = "tb_JH_MRPModel-" + ID;
			...
			return (Demo.Model.tb_JH_MRP)objModel;
		}
        /// <summary>
        /// 获得数据列表
        /// </summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<Demo.Model.tb_JH_MRP> DataTableToList(DataTable dt)
		{
			List<Demo.Model.tb_JH_MRP> modelList = new List<Demo.Model.tb_JH_MRP>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Demo.Model.tb_JH_MRP model;
