...
namespace Demo.BLL
{
	...
	{
		private readonly Demo.DAL.tb_JC_BOMSub dal=new Demo.DAL.tb_JC_BOMSub();
		public tb_JC_BOMSub()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Demo.Model.tb_JC_BOMSub GetModelByCache(string ID)
		{
			
			string CacheKey = "tb_JC_BOMSubModel-" + ID;
			...
			return (Demo.Model.tb_JC_BOMSub)objModel;
		}

		/// <summary>
		/// 获得数据列表
		/// </summary>
		public List<Demo.Model.tb_JC_BOMSub> DataTableToList(DataTable dt)
		{
			List<Demo.Model.tb_JC_BOMSub> modelList = new List<Demo.Model.tb_JC_BOMSub>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Demo.Model.tb_JC_BOMSub model;
