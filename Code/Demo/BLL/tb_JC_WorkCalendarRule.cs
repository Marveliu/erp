...
{
	/// <summary>
	/// tb_JC_WorkCalendarRule
	/// </summary>
	public partial class tb_JC_WorkCalendarRule
	{
		private readonly Demo.DAL.tb_JC_WorkCalendarRule dal=new Demo.DAL.tb_JC_WorkCalendarRule();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Demo.Model.tb_JC_WorkCalendarRule GetModelByCache(string ID)
		{
			
			string CacheKey = "tb_JC_WorkCalendarRuleModel-" + ID;
			...
			return (Demo.Model.tb_JC_WorkCalendarRule)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Demo.Model.tb_JC_WorkCalendarRule> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Demo.Model.tb_JC_WorkCalendarRule> DataTableToList(DataTable dt)
		{
			List<Demo.Model.tb_JC_WorkCalendarRule> modelList = new List<Demo.Model.tb_JC_WorkCalendarRule>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Demo.Model.tb_JC_WorkCalendarRule model;
