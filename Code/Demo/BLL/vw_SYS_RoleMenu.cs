...
namespace Demo.BLL
{
	...
	{
		private readonly Demo.DAL.vw_SYS_RoleMenu dal=new Demo.DAL.vw_SYS_RoleMenu();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Demo.Model.vw_SYS_RoleMenu GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			...
			return (Demo.Model.vw_SYS_RoleMenu)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Demo.Model.vw_SYS_RoleMenu> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Demo.Model.vw_SYS_RoleMenu> DataTableToList(DataTable dt)
		{
			List<Demo.Model.vw_SYS_RoleMenu> modelList = new List<Demo.Model.vw_SYS_RoleMenu>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Demo.Model.vw_SYS_RoleMenu model;
