<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Demo.Web.JH.MPS.Add" %>
            ...
            <Items>
                <f:Form ID="formInfo" ShowBorder="true" LabelAlign="left" ShowHeader="false" runat="server"
                    ...
                    <Rows>
                        ...
                        <f:FormRow>
                            <Items>
                                <f:DatePicker ID="dapEndDate" Label="需求日期" Width="300px" EnableEdit="false" Required="true" runat="server"></f:DatePicker>
                                <f:NumberBox ID="nbxPlanAmount" Label="计划数量" NoNegative="true" DecimalPrecision="2" Width="300px" Required ="true" runat="server"></f:NumberBox>
                            </Items>
                        </f:FormRow> 
                    </Rows>
                </f:Form>
