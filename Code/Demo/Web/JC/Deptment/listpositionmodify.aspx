<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listpositionmodify.aspx.cs" Inherits="Demo.Web.JC.Deptment.modify" %>
    ...
    <form id="_form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true" BodyPadding="10px" runat="server">
            ...
            <Rows>
                <f:FormRow>
                    <Items>
                        <f:TextBox runat="server" ID="positionid" Label="ID" EmptyText="" AutoPostBack="true" Enabled="false"></f:TextBox>
                    </Items>
                </f:FormRow>
