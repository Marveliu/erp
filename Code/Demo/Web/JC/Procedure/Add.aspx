<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Demo.Web.JC.Procedure.Add" %>
            ...
            <Items>
                <f:Form ID="infoForm" ShowBorder="true" LabelAlign="Left" ShowHeader="false" runat="server"
                    ...
                    <Rows>
                        <f:FormRow>
                            <Items>
                                <f:TextBox ID="txbProcedureNO" Width="300px" Label="工序编码" Required="true" runat="server" ></f:TextBox>
                                <f:TextBox ID="txbProcedureName" Width="300px" Label="工序名称" Required="true" runat="server" ></f:TextBox>                                        
                            </Items>
                        </f:FormRow>
                        <f:FormRow>
                            <Items>
