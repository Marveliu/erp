<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Demo.Web.JC.Routing.Modify" %>
            ...
            <Items>
                <f:Form ID="infoForm" LabelAlign="Left" ShowHeader="false" EnableCollapse="false" Expanded="true" 
                    ...
                    <Rows>
                        <f:FormRow>
                            <Items>
                                <f:TextBox ID="txbRoutingNO" Width="300px" Label="工艺路线编号" Readonly="true" runat="server" ></f:TextBox>
