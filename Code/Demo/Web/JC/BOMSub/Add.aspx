<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Demo.Web.JC.BOMSub.Add" %>
            ...
            <Items>
                <f:Form ID="formInfo" ShowBorder="true" LabelAlign="Left" ShowHeader="false" runat="server"
                    ...
                    <Rows>
                        <f:FormRow>
                            <Items>
                                <f:TriggerBox ID="tgbMaterialNO" Label="物料编码" Width="250px" Required="true" EnableEdit="false" TriggerIcon="Search" runat="server">
                                </f:TriggerBox>                                        
